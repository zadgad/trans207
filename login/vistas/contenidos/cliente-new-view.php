...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a class="active" href="<?php echo SERVERURL; ?>cliente-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO CLIENTE</a>
		</li>
		<li>
						...
						<div class="row">
							...
							<div class="col-12 col-md-4">
								<div class="form-group">
									...
									<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="cliente_apellido_reg" id="cliente_apellido" maxlength="35">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="cliente_cliente_reg" id="cliente_cliente" maxlength="35">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									<select class="form-control" name="cliente_privilegio_reg">
