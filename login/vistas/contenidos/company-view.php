<div class="full-box page-header">
    ...
    <p class="text-justify">
        "Richarcod, líder en la comercialización de mobiliario contract, acabados y revestimientos. 10 años de experiencia ofreciendo soluciones innovadoras y productos diferenciados, garantizando siempre la más alta calidad."
    </p>
</div>
...
<div class="container-fluid">
    ...
    <form class="form-neon FormularioAjax"action="" method="POST" data-form="update" autocomplete="off">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="empresa_nombre" class="bmd-label-floating">Nombre de la empresa</label>
                            <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ. ]{1,70}" class="form-control" name="empresa_nombre_up" id="empresa_nombre" maxlength="70" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="empresa_email" class="bmd-label-floating">Correo</label>
                            <input type="email" class="form-control" name="empresa_email_up" id="empresa_email" maxlength="70" value="">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="empresa_telefono" class="bmd-label-floating">Telefono</label>
                            <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="empresa_telefono_up" id="empresa_telefono" maxlength="20" value="">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="empresa_direccion" class="bmd-label-floating">Dirección</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="empresa_direccion_up" id="empresa_direccion" maxlength="190" value="">
                        </div>
                    </div>
                </div>
            </div>
